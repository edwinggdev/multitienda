...
export class LandingWhatsappComponent implements OnInit {
  ...
  celularConfirmar(pedido){
    ...
    let url = "http://localhost/pedidosweb/api/multitienda/celularConfirmar.php";
    url = "https://ginga.com.co/pedidosweb/api/multitienda/celularConfirmar.php";
    url = "https://y79.ae1.mytemp.website/api/multitienda/celularConfirmar.php";
    fetch( url,options)
  ...
  pedidoGuardar(pedido){
    ...
    let url = "http://localhost/pedidosweb/api/multitienda/pedidolw.php";
    url = "https://ginga.com.co/pedidosweb/api/multitienda/pedidolw.php";
    url = "https://y79.ae1.mytemp.website/api/multitienda/pedidolw.php";
  ...
  handleOpenWhatsapp(){
    if( !this.numberId ) {
      let url = "https://wa.me/573210000000?text=";
      window.open( url );
    }
