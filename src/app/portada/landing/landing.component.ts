...
export class LandingComponent implements OnInit {
  ...
  pedidoGuardar(pedido){             
    ...
    const url = "https://ginga.com.co/pedidosweb/api/multitienda/pedido.php";
    fetch( url,options)
  ...
  openWhatsapp( data:any ){
    /*let urlWhatsapp = `https://wa.me/573210000000?text=
    ...
    `;*/
    let urlWhatsapp = `https://wa.me/573112128943?text=${ encodeURIComponent(` Hola Servicio al Cliente de admin
