...
export class FormcrearguiaComponent implements OnInit {
  ...
  rellenoData(){
    ...
    this.data2 = {
      ...
      txtDireccionDe: "Calle 5 Av 15",
      txtCod_Postal_Rem: 540001,
      txtEMailRemitente: this.dataUser.usu_email || "edwingarciagaitan82@gmail.com",
      ...
      txtNotas: "ok",
      txtEMailDestinatario: "edwingarcigaitan82@gmail.com",
      ...
      direccionCliente: "",
      emailRemitente: this.dataUser.usu_email || "calzadocolombia@gmail.com",
