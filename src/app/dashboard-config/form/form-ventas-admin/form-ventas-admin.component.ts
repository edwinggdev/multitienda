...
@Component({
  selector: 'app-form-ventas-admin',
  templateUrl: './form-ventas-admin.component.html',
  styleUrls: ['./form-ventas-admin.component.scss']
})
export class FormVentasadminComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<FormVentasadminComponent>,
