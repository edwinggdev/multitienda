...
import { FormVentasadminComponent } from '../../form/form-ventas-admin/form-ventas-admin.component';
...
@Component({
  selector: 'app-list-ventas-admin',
  templateUrl: './list-ventas-admin.component.html',
  styleUrls: ['./list-ventas-admin.component.scss']
})
export class ListVentasadminComponent implements OnInit {
  ...
  crear(obj:any){
    const dialogRef = this.dialog.open(FormVentasadminComponent,{
      data: {datos: obj || {}}
    });
