...
export class VentasService {
  ...
  getVentasL(query:any){
    return this._model.querys('ventaAdmin/querys',query, 'post');
  }
  createVentasL(query:any){
    return this._model.querys('ventaAdmin',query, 'post');
  }
  updateVentasL(query:any){
    return this._model.querys('ventaAdmin/'+query.id,query, 'put');
  }
