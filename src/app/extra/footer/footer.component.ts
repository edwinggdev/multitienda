...
export class FooterComponent implements OnInit {
  ...
  listaBanner() {
    ...
    for (let i = 0; i < 18; i++) {
      ...
      this.imageObject.push({
        ...
        alt: 'https://multitienda.wixsite.com/misitio-1',
        id: i,
      });
    }
  }
  ...
  handleWhatsapp(){
    console.log("*88ENTRE")
    let url = "https://wa.me/57321000000?text=Hola Servicio al cliente";
    window.open(url);
  }

  openaVenta() {
    let url: string = `https://multitienda.wixsite.com/misitio`;
    window.open(url);
  }
