  ...
  openShare(obj: any) {
    if (navigator['share']) {
      navigator['share']({
        ...
        text: obj.foto + `link del producto $${obj.pro_uni_venta.toLocaleString(1)} COP ---> https://www.multitienda.com/productos/${obj.id} }`,
        url: obj.foto,
      })
      ...
      let url = `https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&u=https://www.multitienda.com/productos/15?u=https://www.multitienda.com/productos/${obj.id}`;
      window.open(url);
    }
  }
